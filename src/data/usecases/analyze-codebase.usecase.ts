...
export class AnalyzeCodebaseUseCase implements IAnalyzeCodebase {
  ...
  private async validateArchitecture(
    ...
    // DEDUPLICATION: Remove duplicate violations for same file+rule combination
    // This fixes stuttering bug where same file was reported 24x (once per export/symbol)
   ...
   * generate duplicate violations. This method keeps only the first occurrence.
   *
  ...
  private deduplicateViolations(
    violations: ArchitecturalViolationModel[]
  ): ArchitecturalViolationModel[] {
